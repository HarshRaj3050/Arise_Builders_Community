...
export default function Footer() {
  return (
    <footer className=" bg-black w-full text-white h-auto px-6 flex justify-center  pt-20">
      <div className="w-full px-[9vw]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14">
          ...
          <div className="space-y-8">
            ...
            <p className="text-zinc-500 text-sm">© 2026 Copyright</p>
          </div>

          <div className="flex justify-around">
            {/* Menu */}
            <div className="md:pl-20 flex flex-col items-center">
              <h3 className="text-2xl font-semibold mb-8">Menu</h3>
            ...
            <div className="flex flex-col pl-10">
              <h3 className="text-2xl font-semibold mb-8">Navigation</h3>
